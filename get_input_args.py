...
def get_input_args():
    ...
    parser.add_argument('--image_path', default='ImageClassifier/flowers/train/19/image_06149.jpg', type= str, help = 'path to predict image', action='store')
    parser.add_argument('--train_set', default='ImageClassifier/flowers/train', help = 'path to predict image')
    parser.add_argument('--arch', type = str, choices=['VGG', 'DenseNet'], default = 'VGG')
